    ...
    <SmoothScroll>
      ...
      <AuroraBackground className="min-h-screen pt-32 pb-20">
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          ...
          <h1 className="font-heading text-5xl md:text-[96px] leading-[1.05] font-bold tracking-tight mb-8 max-w-5xl">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gradient-01-start)] via-[var(--color-gradient-01-mid1)] to-[var(--color-gradient-01-end)] pb-2">
              intelligent automation
            </span>
          </h1>
          
          <p className="text-lg md:text-[22px] text-muted max-w-[700px] mb-12 leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 w-full sm:w-auto">
            <Button size="lg" className="magnetic group w-full sm:w-auto">
              Start Transformation
              <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="outline" className="magnetic w-full sm:w-auto">
              Explore Services
            </Button>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
            <div className="max-w-2xl">
              <h2 className="font-heading text-4xl md:text-[56px] leading-[1.1] font-bold tracking-tight mb-6">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-gradient-02-start)] to-[var(--color-gradient-02-end)] pb-2">
                  sustainable growth
                </span>
              </h2>
            ...
            <Button variant="outline" className="shrink-0 magnetic">
              View All Solutions
            </Button>
          </div>
              ...
              <div className="relative rounded-[32px] border border-white/10 bg-white/5 backdrop-blur-[40px] p-10 shadow-[0_20px_80px_rgba(0,0,0,0.5)]">
                ...
                <div className="flex items-center justify-between mb-10 pb-8 border-b border-white/10">
                  <div>
                    ...
                    <div className="text-5xl font-bold font-heading text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">+342%</div>
                  </div>
                  ...
                  {[1, 2, 3].map((_, i) => (
                    <div key={i} className="flex items-center gap-6 p-4 rounded-2xl hover:bg-white/5 transition-colors cursor-pointer group">
                      ...
                      <div className="flex-1 space-y-3">
                        <div className="h-3.5 bg-white/20 rounded-full w-full max-w-[200px]" />
      ...
      <section className="py-40 relative z-10 border-t border-white/[0.04] overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative flex flex-col items-center text-center">
          ...
          <Button size="lg" className="magnetic group h-16 px-10 text-[18px]">
