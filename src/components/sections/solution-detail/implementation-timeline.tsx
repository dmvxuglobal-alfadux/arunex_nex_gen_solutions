...
export const ImplementationTimeline = ({ data }: { data: SolutionData }) => {
        ...
        <ScrollReveal>
          <div className="text-center max-w-[800px] mx-auto mb-24">
            ...
            <p className="text-lg text-white/60 font-light leading-relaxed">
              A structured, transparent roadmap to ensure successful adoption.
            </p>
          </div>
        </ScrollReveal>
              ...
              <div key={i} className={cn(
                ...
                >
                  <div className="group p-8 rounded-[24px] bg-white/[0.02] border border-white/5 backdrop-blur-md hover:bg-white/[0.04] transition-all duration-300">
                    <h3 className="font-heading text-2xl font-bold text-white tracking-tight mb-6">
                      {step.title}
                    </h3>
                    ...
                    <div className="space-y-4 text-left">
                      ...
                      <div>
                        <div className="text-[11px] font-mono text-[var(--color-gradient-01-end)]/70 uppercase tracking-widest mb-1.5">Deliverables</div>
                        <p className="text-[15px] text-white font-medium leading-relaxed">{step.deliverables}</p>
                      </div>
                    </div>
                  </div>
                </ScrollReveal>
